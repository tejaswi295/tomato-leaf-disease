  ...
  return (
    <header className="h-16 border-b border-app-border bg-white flex items-center justify-between px-6 shrink-0 z-40 relative shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <a href="https://github.com/tejaswi295/tomato-leaf-disease" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-4 py-2 hover:bg-slate-50 border border-slate-200 rounded-xl transition-colors text-app-textSecondary hover:text-slate-900 cursor-pointer text-sm font-medium">
